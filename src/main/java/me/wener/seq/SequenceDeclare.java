...
public class SequenceDeclare {
    ...
    private final static Config DEFAULT_CONFIG = asc().build().toConfig();
    ...
    public Config toConfig() {
        ...
        attrs.put("name", name);
        return ConfigFactory.parseMap(attrs);
    }

    public Builder fromConfig(final Config cfg) {
        Config c = cfg.withFallback(DEFAULT_CONFIG);
        return new Builder()
                .min(c.getLong("min"))
                .max(c.getLong("max"))
